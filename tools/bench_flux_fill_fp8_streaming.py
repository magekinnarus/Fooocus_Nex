...
def _run_case(
    *,
    ...
    return {
        ...
        "source_weight_dtype": str(detected_config.get("source_weight_dtype", "")),
        "resident_weight_dtype": str(detected_config.get("resident_weight_dtype", "")),
        "manual_cast_dtype": str(detected_config.get("manual_cast_dtype", "")),
        "compute_weight_dtype": str(flux_options.get("compute_weight_dtype", "")),
        ...
        "resident_weight_mb": float(flux_options.get("runtime_weight_bytes", 0)) / (1024 * 1024),
